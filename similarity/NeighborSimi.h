...
public:
	NeighborSimi();
	NeighborSimi(double * sampleClimateV, double * sampleGeologyV, double * sampleTerrainV,
	...
	void getNeighborAvgSimi(double *climateStd,double *geoStd,double *terrainStd,double *vegetationStd,double *otherStd,
